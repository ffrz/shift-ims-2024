    ...
    <div class="card card-light">
      <div class="card-header" style="padding:0;border-bottom:0;">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
          ...
          <li class="nav-item">
            <a class="nav-link" id="company-profile-tab" data-toggle="tab" href="#company-profile" role="tab"
            ...
            <div class="form-row">
              <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control @error('company_name') is-invalid @enderror" id="company_name"
                  ...
                  value="{{ Setting::value('company.name', 'Toko Saya') }}">
                @error('company_name')
            ...
            <div class="form-row">
              <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control @error('company_owner') is-invalid @enderror"
                  id="company_owner" placeholder="Nama Pemilik" name="company_owner"
                  value="{{ Setting::value('company.owner') }}">
                @error('company_owner')
                  <span class="text-danger">
                    {{ $message }}
                  </span>
